...
?>    
    ...
    <div id="customfooter">
      ...
      <ul id="social_ico">
        <li><a href="https://www.facebook.com/instantimmo?fref=ts"><img src="<?php echo get_template_directory_uri(); ?>/img/fb.png"></a></li>
        <li><a href="https://twitter.com/instantimmo"><img src="<?php echo get_template_directory_uri(); ?>/img/twitter.png"></a></li>
        <li><a href="https://www.linkedin.com/company/912812"><img src="<?php echo get_template_directory_uri(); ?>/img/in.png"></a></li>
      </ul>
