...
<div class="user_profile_div"> 
    ...
    <div class="add-estate profile-page row">  
        ...
        <div class="add-estate profile-page row">  
            <button class="wpb_button buttons  wpb_btn-large" id="update_profile"><?php _e('Update profile','wpestate');?></button>
        </div>
        ...
        <div class="profile-page row">  
            ...
            <button class="wpb_button buttons wpb_btn-large vc_button" id="change_pass"><?php _e('Reset Password','wpestate');?></button>
        </div>
    </div>