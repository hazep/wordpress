...
<div class="col-md-2">
    ...
    <form method="POST" action="<?= $_SERVER['REQUEST_URI'] ?>">
        <input type="text" placeholder="Laisser une note..." name="mynote" class="form-control note-input" <?php if($count_note[0]->count === '5') print "disabled"?>>
        <input type="submit" value="créer" name="createnote" class="buttons button-input" <?php if($count_note[0]->count === '5') print "disabled"?>>
    </form>
    <?php
        get_template_part('templates/user_notes');
    ?>
    <?php } ?>
</div>
