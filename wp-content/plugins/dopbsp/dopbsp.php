            ...
            function initBackEnd(){
                ...
                if (function_exists('add_options_page')){
                    ...
                    add_submenu_page('dopbsp', $this->text('CALENDARS_TITLE'), $this->text('CALENDARS_TITLE'), $this->vars->role_action, 'dopbsp-calendars', array(&$this->classes->backend_calendars, 'view'));
                        DOPBSP_DEVELOPMENT_MODE ? add_submenu_page('dopbsp', $this->text('EVENTS_TITLE').$this->text('SOON'), $this->text('EVENTS_TITLE').$this->text('SOON'), $this->vars->role_action, 'dopbsp-events', array(&$this->classes->backend_events, 'view')):'';
                        DOPBSP_DEVELOPMENT_MODE ? add_submenu_page('dopbsp', $this->text('STAFF_TITLE').$this->text('SOON'), $this->text('STAFF_TITLE').$this->text('SOON'), $this->vars->role_action, 'dopbsp-staff', array(&$this->classes->backend_staff, 'view')):'';
