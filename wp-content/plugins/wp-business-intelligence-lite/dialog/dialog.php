...
$wpbi_dialog['page']['connections']['test-description'] 		= 	__('Testing will only check DB connectivity but NOT the schema name.', 'wpbusinessintelligence');
...
$wpbi_dialog['field']['connections']['type']				= 	__('DB Type', 'wpbusinessintelligence');
...
$wpbi_dialog['header']['connections']['type']				= 	__('DB Type', 'wpbusinessintelligence');
...
$wpbi_dialog['form']['label']['table-download']				= 	__('Enable Download', 'wpbusinessintelligence');
...
$wpbi_dialog['form']['label']['chart-time-format']			= 	__('Time Format', 'wpbusinessintelligence');
...
$wpbi_dialog['charts']['type']['heatmap']				= 	__('Heatmap', 'wpbusinessintelligence');
$wpbi_dialog['charts']['type']['treemap']				= 	__('Treemap', 'wpbusinessintelligence');
$wpbi_dialog['charts']['type']['sunburst']				= 	__('Sunburst', 'wpbusinessintelligence');
$wpbi_dialog['charts']['type']['hierarchicalbars']		= 	__('Hierarchical Bars', 'wpbusinessintelligence');
$wpbi_dialog['charts']['type']['sankey']				= 	__('Sankey', 'wpbusinessintelligence');
$wpbi_dialog['charts']['type']['rttree']				= 	__('Reingold Tilford', 'wpbusinessintelligence');
$wpbi_dialog['charts']['type']['zoomablebubbles']		= 	__('Zoomable Bubbles', 'wpbusinessintelligence');
...
$wpbi_dialog['charts']['heatmap']['tooltip']				= 	__('#val#', 'wpbusinessintelligence');
$wpbi_dialog['charts']['treemap']['tooltip']				= 	__('#val#', 'wpbusinessintelligence');
$wpbi_dialog['charts']['hierarchicalbars']['tooltip']		= 	__('#val#', 'wpbusinessintelligence');
$wpbi_dialog['charts']['sunburst']['tooltip']				= 	__('#val#', 'wpbusinessintelligence');
$wpbi_dialog['charts']['sankey']['tooltip']				= 	__('#val#', 'wpbusinessintelligence');
$wpbi_dialog['charts']['rttree']['tooltip']				= 	__('#val#', 'wpbusinessintelligence');
$wpbi_dialog['charts']['zoomablebubbles']['tooltip']				= 	__('#val#', 'wpbusinessintelligence');
