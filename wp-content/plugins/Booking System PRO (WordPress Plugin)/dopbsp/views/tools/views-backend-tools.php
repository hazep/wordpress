                        ...
                        <td class="dopbsp-column" id="DOPBSP-column1">
                            ...
                            <div class="dopbsp-column-content">
                                <ul>
                                    ...
                                    <li class="dopbsp-tools-item dopbsp-repair-search-settings" onclick="DOPBSPTools.toggle('repair-search-settings'); DOPBSP.confirmation('TOOLS_REPAIR_SEARCH_SETTINGS_CONFIRMATION', 'DOPBSPToolsRepairSearchSettings.init()', 'DOPBSPTools.toggle()')">
                                        <div class="dopbsp-icon"></div>
