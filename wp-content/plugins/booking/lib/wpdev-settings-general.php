        ...
        <div class="booking-submenu-tab-container">
            <div class="nav-tabs booking-submenu-tab-insidecontainer">
                ...
                <?php /** ?><a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_main' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Main', 'wpdev-booking');?></span></a><?php /**/ ?>

                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_calendar' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Calendar', 'wpdev-booking');?></span></a>

                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_form' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Form', 'wpdev-booking');?></span></a>
                
                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_bktable' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Booking Listing', 'wpdev-booking');?></span></a>
                ...
                <?php if ( class_exists('wpdev_bk_biz_s')) { ?>
                    ...
                    <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_settings_general_cost_options' );"
                        class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Costs', 'wpdev-booking');?></span></a>

                    <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_settings_auto_cancel_pending_nk' );"
                        class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Auto cancellation / approval', 'wpdev-booking');?></span></a>
                    ...
                    <?php /*if ( class_exists('wpdev_bk_biz_l')) { ?>
                        ...
                        <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_settings_resources_advanced_options' );"
                            class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Advanced', 'wpdev-booking');?></span></a>
                ...
                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_users_permissions' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Menu access', 'wpdev-booking');?></span></a>
                
                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_uninstall' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Uninstall', 'wpdev-booking');?></span></a>
                
                <a href="javascript:void(0)" onclick="javascript:makeScrollInAdminPanel('#bk_general_settings_technical_section' );"
                   class="nav-tab booking-submenu-tab go-to-link" ><span><?php _e('Technical', 'wpdev-booking');?></span></a>
                
                <input type="button" class="button-primary button" value="<?php _e('Save Changes','wpdev-booking'); ?>" 
                   style="float:right;"
...
//        }
    ...
    if ( isset( $_POST['start_day_weeek'] ) ) {
        ...
        if ( isset($wpbc->notice) )
            $wpbc->notice->show_message( __('Settings saved', 'wpdev-booking'), 15 );    
    }
    ?>
            ...
            <div class='meta-box'>
                <div <?php $my_close_open_win_id = 'bk_general_settings_main'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                    <h3 class='hndle'><span><?php _e('Main', 'wpdev-booking'); ?></span></h3> <div class="inside">
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="email_reservation_adress" ><?php _e('Admin email', 'wpdev-booking'); ?>:</label></th>
                            <td><input id="email_reservation_adress"  name="email_reservation_adress" class="large-text" type="text" value="<?php echo $email_reservation_adress; ?>" />
                                <p class="description"><?php printf(__('Type default %sadmin email%s for booking confirmation', 'wpdev-booking'),'<b>','</b>');?></p>
                            </td>
                        </tr>
            ...
            <h3 class='hndle'><span><?php _e('Calendar', 'wpdev-booking'); ?></span></h3> <div class="inside">
                <table class="form-table"><tbody>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                    <?php $dir_list = wpdev_bk_dir_list( array(  '/css/skins/', '/inc/skins/' ) ); ?>
                                <select id="booking_skin" name="booking_skin" style="text-transform:capitalize;">
                                    <?php foreach ($dir_list as $value) {
                                        ...
                                        if (  strpos( str_replace(WPDEV_BK_PLUGIN_URL, '', $booking_skin) , $value[0]) !== false ) $selected_item =  'selected="SELECTED"';
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="max_monthes_in_calendar" ><?php _e('Number of months', 'wpdev-booking'); ?>:</label></th>
                            <td>
                                ...
                                <span class="description"><?php _e('Select the maximum number of months to show (scroll)', 'wpdev-booking');?></span>
                            </td>
                        </tr>
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e('Unavailable week days', 'wpdev-booking'); ?>:</th>
                            <td>    
                                ...
                                <label for="unavailable_day3" class="wpbc-single-checkbox">
                                    ...
                                    <?php _e('Wednesday', 'wpdev-booking'); ?>
                                </label>
                                ...
                                <label for="unavailable_day6" class="wpbc-single-checkbox">
                                    ...
                                    <?php _e('Saturday', 'wpdev-booking'); ?>
                                </label>
                                <p class="description"><?php _e('Check unavailable days in calendars. This option will overwrite all other settings.', 'wpdev-booking');?></p>
                            </td>
                        </tr>
...
<?php /* Allow multiple bookings per same day previusly  was here  */ ?>                                                
                        ...
                        <tr valign="top">
                            <th scope="row"><?php _e('Type of days selection in calendar', 'wpdev-booking'); ?>:</th>
                            <td>
                                <fieldset>
                                    <legend class="screen-reader-text"><span><?php _e('Type of days selection', 'wpdev-booking'); ?></span></legend>
                                    <label for="type_of_day_selections_single">
                                        <input  value="single" <?php if ( ($type_of_day_selections == 'single') || (empty($type_of_day_selections)) ) echo 'checked="CHECKED"'; ?>
                                            ...
                                            name="type_of_day_selections" id="type_of_day_selections_single" type="radio" 
                                             />
                                        <span><?php _e('Single day', 'wpdev-booking');?></span>
                                    </label><br />
                                    ...
                                    <label for="type_of_day_selections_multiple">
                                        <input  value="multiple" <?php if ($type_of_day_selections == 'multiple')  echo 'checked="CHECKED"'; ?> 
                                            ...
                                            name="type_of_day_selections" id="type_of_day_selections_multiple"  type="radio" 
                                             />
                                        <span><?php _e('Multiple days', 'wpdev-booking');?></span>
                                    </label><br />
                                    ...
                                    <label for="type_of_day_selections_range">
                                        <input  value="range" <?php if ($type_of_day_selections == 'range')  echo 'checked="CHECKED"'; ?>
                                            ...
                                            name="type_of_day_selections" id="type_of_day_selections_range"  type="radio" 
                                             />
                                        <span><?php _e('Range days', 'wpdev-booking');?></span>
                                    </label>
                                    <?php } ?>
                ...
                <div <?php $my_close_open_win_id = 'bk_general_settings_form'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                    <h3 class='hndle'><span><?php _e('Form', 'wpdev-booking'); ?></span></h3> <div class="inside">
                        ...
                        <table class="form-table"><tbody>
                            ...
                            ?> 
                            <tr valign="top">
                                <th scope="row"><?php _e('CAPTCHA', 'wpdev-booking'); ?>:</th>
                                <td><fieldset><label for="is_use_captcha">                                            
                                        ...
                                        <?php _e('Check the box to activate CAPTCHA inside the booking form.', 'wpdev-booking');?>
                                    </label>
                                    </fieldset>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                <th scope="row"><?php _e('Auto-fill fields', 'wpdev-booking'); ?>:</th>
                                <td><fieldset><label for="is_use_autofill_4_logged_user" >
                                        ...
                                        <?php _e('Check the box to activate auto-fill form fields for logged in users.', 'wpdev-booking');?>
                                    </label>
                                    </fieldset>    
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                <th scope="row"><?php _e('Use CSS BootStrap', 'wpdev-booking'); ?>:</th>
                                <td><fieldset><label for="booking_form_is_using_bs_css">
                                     ...
                                     <p class="description"><strong><?php _e('Note', 'wpdev-booking'); ?>:</strong> <?php _e('You must not deactivate loading BootStrap files at advanced section of these settings!', 'wpdev-booking'); ?></p>
                                </td>
                            </tr>                                    
                            ...
                            <tr valign="top" style="padding: 0px;">
                                <th scope="row"><?php _e('Action after booking is done', 'wpdev-booking'); ?>:</th>
                                <td>
                                    <fieldset>
                                    <label for="type_of_thank_you_message_message">
                                        ...
                                        <span><?php _e('Show "Thank You" message', 'wpdev-booking'); ?></span>
                                    </label><br />
                                    <label for="type_of_thank_you_message_page">
                                        ...
                                        <span><?php _e('Redirect visitor to a new "Thank You" page', 'wpdev-booking'); ?></span>
                                    </label>
                                    </fieldset>
                                    <?php if ( class_exists('wpdev_bk_biz_s') ) { ?>
                                    <p class="description"><strong><?php _e('Note', 'wpdev-booking'); ?>:</strong> <?php _e('This action will have no effect, if the payment form(s) is active!', 'wpdev-booking'); ?></p>
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr valign="top" style="padding: 0px;"><td colspan="2"  style="padding:0px;">
                                ...
                                <table id="togle_settings_thank-you_message" style="width:100%;<?php if ($type_of_thank_you_message != 'message') echo 'display:none;';/**/ ?>" class="hided_settings_table">
                                    <tr valign="top">
                                        <th><label for="new_booking_title"><?php _e('Message title', 'wpdev-booking'); ?>:</label></th>
                                        <td>
                                            <input id="new_booking_title" class="large-text" type="text" value="<?php echo $new_booking_title; ?>" name="new_booking_title" />
                                            <p class="description"><?php printf(__('Type title of message %safter booking has done by user%s', 'wpdev-booking'),'<b>','</b>');?></p>                                                
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th><label for="new_booking_title_time"><?php _e('Time of message showing', 'wpdev-booking'); ?>:</label></th>
                                        <td>
                                            ...
                                            <p class="description"><?php printf(__('Set duration of time (milliseconds) to show this message', 'wpdev-booking'),'<b>','</b>');?></p>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table id="togle_settings_thank-you_page" style="width:100%;<?php if ($type_of_thank_you_message != 'page') echo 'display:none;';/**/ ?>" class="hided_settings_table">
                                    <tr valign="top">
                                    <th scope="row"><label for="thank_you_page_URL" ><?php _e('URL of "thank you" page', 'wpdev-booking'); ?>:</label></th>
                                        <td>
                                            <fieldset>
                                            ...
                                            <p class="description"><?php printf(__('Type URL of %s"Thank You" page%s', 'wpdev-booking'),'<b>','</b>');?></p>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table class="form-table"><tbody>
                            ...
                            <tr valign="top">
                                ...
                                <fieldset>
                                    ...
                                    echo '&nbsp;&nbsp;';
                                    ?>
                                    <p class="description"><?php printf(__('Type your date format for emails and the booking table. %sDocumentation on date formatting%s', 'wpdev-booking'),'<a href="http://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">','</a>');?></p>
                                </fieldset>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                <th scope="row">
                                    <?php _e('Show / hide hints', 'wpdev-booking'); ?>:
                                </th>
                                <td>
                                    <fieldset>
                                        <label for="is_use_hints_at_admin_panel" >
                                            ...
                                            <?php _e('Check this box if you want to show help hints on the admin panel.', 'wpdev-booking');?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
                ...
                <div <?php $my_close_open_win_id = 'bk_settings_resources_advanced_options'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                      <h3 class='hndle'><span><?php _e('Advanced', 'wpdev-booking'); ?></span></h3> <div class="inside">
                          <table class="form-table"><tbody>
                            ...
                            <tr valign="top">
                                 <th scope="row"><?php 
                                     $show_untill_version_update = '5.4';  $wpbc_settings_element = 'dismiss_new_booking_check_on_server_if_dates_free'; if ( ( version_compare(WP_BK_VERSION_NUM, $show_untill_version_update ) < 0 ) && ( '1' != get_user_option( 'booking_win_' . $wpbc_settings_element ) ) ) { ?><div id="<?php echo $wpbc_settings_element; ?>"  class="new-label clearfix-height new-label-settings"><a class="tooltip_bottom" data-original-title="<?php _e('Hide','wpdev-booking'); ?>" rel="tooltip" href="javascript:void(0)"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $wpbc_settings_element; ?>');jQuery('#<?php echo $wpbc_settings_element; ?>').hide();" ><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/label_new_blue.png" style="width:24px; height:24px;"></a></div><?php } /**/ ?> 
                                     <?php _e('Checking to prevent double booking, during submitting booking', 'wpdev-booking'); ?>:</th>
                                 <td>
                                    <fieldset>
                                        <label for="booking_check_on_server_if_dates_free" >                     
                                            <input <?php if ($booking_check_on_server_if_dates_free == 'On') echo "checked"; ?>  
                                                ...
                                                onclick="javascript: if (this.checked) { var answer = confirm('<?php  _e('Warning','wpdev-booking'); echo '! '; _e("This feature can impact to speed of submitting booking. Do you really want to do this?", 'wpdev-booking'); ?>'); if ( answer){ this.checked = true; jQuery('#booking_is_days_always_available').prop('checked', false ); } else {this.checked = false;} }"                            
                                              />
                                            <?php printf(__('Check this box, if you want to %sre-check if the selected dates available during submitting booking%s.', 'wpdev-booking'), '<strong>', '</strong>' , '<strong>', '</strong>' );?>
                                        </label>
                                    </fieldset>
                                    <span class="description" style="padding:0;"><strong><?php _e('Note', 'wpdev-booking'); ?>!</strong> <?php 
                                        _e('This feature useful to prevent double booking of the same date(s) or time(s), if several visitors try to book the same date(s) in same calendar during the same time.', 'wpdev-booking');
                                        if ( class_exists('wpdev_bk_biz_l')) { 
                                            echo ' ';
                                            _e('This feature does not work for booking resources with capacity higher than one.', 'wpdev-booking');
                                        } ?>                                        
                                    </span>
                                 </td>
                             </tr>
                            ...
                            <tr valign="top">
                                 <th scope="row"><?php 
                                        /* $show_untill_version_update = '5.3';  $wpbc_settings_element = 'dismiss_new_booking_is_days_always_available'; if ( ( version_compare(WP_BK_VERSION_NUM, $show_untill_version_update ) < 0 ) && ( '1' != get_user_option( 'booking_win_' . $wpbc_settings_element ) ) ) { ?><div id="<?php echo $wpbc_settings_element; ?>"  class="new-label clearfix-height new-label-settings"><a class="tooltip_bottom" data-original-title="<?php _e('Hide','wpdev-booking'); ?>" rel="tooltip" href="javascript:void(0)"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $wpbc_settings_element; ?>');jQuery('#<?php echo $wpbc_settings_element; ?>').hide();" ><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/label_new_blue.png" style="width:24px; height:24px;"></a></div><?php } */ ?> 
                                     <?php _e('Allow unlimited bookings per same day(s)', 'wpdev-booking'); ?>:</th>
                                 <td>
                                    <fieldset>
                                        <label for="booking_is_days_always_available" >                     
                                            <input <?php if ($booking_is_days_always_available == 'On') echo "checked"; ?>  
                                                ...
                                                onclick="javascript: if (this.checked) { var answer = confirm('<?php  _e('Warning','wpdev-booking'); echo '! '; _e("You allow unlimited number of bookings per same dates, its can be a reason of double bookings on the same date. Do you really want to do this?", 'wpdev-booking'); ?>'); if ( answer){ this.checked = true; jQuery('#booking_check_on_server_if_dates_free').prop('checked', false );jQuery('#booking_is_show_pending_days_as_available').prop('checked', false );jQuery('#togle_settings_show_pending_days_as_available').slideUp('normal'); } else {this.checked = false;} }"                            
                                              />
                                            <?php printf(__('Check this box, if you want to %sset any days as available%s in calendar. Your visitors will be able to make %sunlimited bookings per same date(s) in calendar and do not see any booked date(s)%s of other visitors.', 'wpdev-booking'), '<strong>', '</strong>' , '<strong>', '</strong>' );?>
                                        </label>
                                    </fieldset>
                                 </td>
                             </tr>
                            ...
                            <tr valign="top"> <td colspan="2">
                                ...
                                <table id="togle_settings_javascriptloading" style="display:none;" class="hided_settings_table">
                                    ...
                                    <tr valign="top">
                                        <th scope="row">
                                            <?php _e('Disable Bootstrap loading on Front-End', 'wpdev-booking'); ?>:
                                        </th>
                                        <td>
                                            <fieldset>
                                                <label for="is_not_load_bs_script_in_client" >
                                                    <input id="is_not_load_bs_script_in_client" type="checkbox" <?php if ($is_not_load_bs_script_in_client == 'On') echo "checked"; ?>  value="<?php echo $is_not_load_bs_script_in_client; ?>" name="is_not_load_bs_script_in_client"
                                                           ...
                                                           />
                                                    <?php _e(' If your theme or some other plugin is load the BootStrap JavaScripts, you can disable  loading of this script by this plugin.', 'wpdev-booking');?>                                                                                                                
                                                </label>
                                            </fieldset>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        <th scope="row">
                                            <?php _e('Disable Bootstrap loading on Back-End', 'wpdev-booking'); ?>:
                                        </th>
                                        <td>
                                            <fieldset>
                            ...
                            <tr valign="top"> <td colspan="2">
                                ...
                                <table id="togle_settings_powered" style="display:none;" class="hided_settings_table">
                                        ...
                                        <tr valign="top">
                                            <th scope="row">
                                                <?php _e('Powered by notice', 'wpdev-booking'); ?>:</th>
                                            <td>
                                                <fieldset>
                                                    <label for="booking_is_show_powered_by_notice" >
                                                        ...
                                                        <?php printf(__(' Turn On/Off powered by "Booking Calendar" notice under the calendar.', 'wpdev-booking'),'wpbookingcalendar.com');?>
                                                    </label>
                                                </fieldset>
                                        ...
                                        <tr valign="top">
                                            <th scope="row">
                                                <?php _e('Help and info notices', 'wpdev-booking'); ?>:
                                            </th>
                                            <td>
                                                <fieldset>
                                                    <label for="wpdev_copyright_adminpanel" >
                                                        ...
                                                        <?php printf(__(' Turn On/Off version notice and help info links at booking admin panel.', 'wpdev-booking'),'wpbookingcalendar.com');?>
                                                    </label>
                                                </fieldset>
            ...
            <div class='meta-box'>
                <div <?php $my_close_open_win_id = 'bk_general_settings_users_permissions'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                    ...
                    <table class="form-table"><tbody>
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="user_role_booking" ><?php _e('Bookings', 'wpdev-booking'); ?>:</label></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="user_role_addbooking" ><?php _e('Add booking', 'wpdev-booking'); ?>:</label></th>
                            <td>
                        ...
                        <?php if  ($version !== 'free') { ?>
                            <tr valign="top">
                                <th scope="row"><label for="user_role_resources" ><?php _e('Resources', 'wpdev-booking'); ?>:</label></th>
                                <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="user_role_settings" ><?php _e('Settings', 'wpdev-booking'); ?>:</label></th>
                            <td>
                        ...
                        <tr valign="top">
                            <td colspan="2">
                                ...
                                <p class="description"><?php _e('Select user access level for the menu pages of plugin', 'wpdev-booking');?></p>
                            </td>
                        </tr>
                ...
                <div <?php $my_close_open_win_id = 'bk_general_settings_uninstall'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                    <h3 class='hndle'><span><?php _e('Uninstall / deactivation', 'wpdev-booking'); ?></span></h3> <div class="inside">
                        <table class="form-table"><tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><?php _e('Delete booking data, when plugin deactivated', 'wpdev-booking'); ?>:</th>
                                <td>
                                    <fieldset>
                                        <label for="is_delete_if_deactive">
                                            <input id="is_delete_if_deactive" type="checkbox" <?php if ($is_delete_if_deactive == 'On') echo "checked"; ?>  value="<?php echo $is_delete_if_deactive; ?>" name="is_delete_if_deactive"
                                                onclick="javascript: if (this.checked) { var answer = confirm('<?php  _e('Warning','wpdev-booking'); echo '! '; _e("If you check this option, all booking data will be deleted when you uninstall this plugin. Do you really want to do this?", 'wpdev-booking'); ?>'); if ( answer){ this.checked = true; } else {this.checked = false;} }"
                                                   />
                                            <?php _e('Check this box to delete all booking data when you uninstal this plugin.', 'wpdev-booking');?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
        ...
        <div class="clear" style="height:10px;"></div>
        <input class="button-primary button" style="float:right;" type="submit" value="<?php _e('Save Changes', 'wpdev-booking'); ?>" name="Submit"/>
        <div class="clear" style="height:10px;"></div>
    </form>
    </div>    
    <?php    
        ...
        <div class='meta-box'>
            ...
            <div class="inside">
                ...
                <p style="line-height:25px;text-align:center;padding-top:15px;" class="wpdevbk">                    
                    <a class="button button-primary" style="font-size: 1.1em;font-weight: bold;height: 2.5em;line-height: 1.1em;padding: 8px 25px;"  href="<?php echo wpbc_up_link(); ?>" target="_blank"><?php if ( wpbc_get_ver_sufix() == '' ) { _e('Purchase', 'wpdev-booking'); } else { _e('Upgrade Now', 'wpdev-booking'); } ?></a>
                </p>    
...
function wpdev_bk_settings_legend_section(){
     ...
     ?>
           <tr valign="top" class="ver_premium_plus">
                <th scope="row">
                    <?php _e('Show legend below calendar', 'wpdev-booking'); ?>:
                </th>
                <td>
                    <fieldset>
                    <label for="booking_is_show_legend" >
                        <input <?php if ($booking_is_show_legend == 'On') echo "checked";/**/ ?>  value="<?php echo $booking_is_show_legend; ?>" name="booking_is_show_legend" id="booking_is_show_legend" type="checkbox"
                             onclick="javascript: if (this.checked) jQuery('#togle_settings_show_legend').slideDown('normal'); else  jQuery('#togle_settings_show_legend').slideUp('normal');"
                                                                                                      />
                        <?php _e('Check this box to display a legend of dates below the booking calendar.', 'wpdev-booking');?>
                    </label>
                    </fieldset>    
                </td>
            </tr>
                    ...
                    <?php if ( class_exists('wpdev_bk_biz_s') ) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="description"><strong><?php _e('Note', 'wpdev-booking'); ?>:</strong> <?php printf(__('Partially booked item - day, which is booked for the specific time-slot(s).', 'wpdev-booking'),'<b>','</b>');?></p>
                                <?php //make_bk_action('show_additional_translation_shortcode_help'); ?>
                            </td>
                        </tr>
                    <?php } ?>
...
function wpdev_bk_settings_form_labels(){ 
    ...
    <div id="poststuff0" class="metabox-holder">
        <form  name="post_settings_form_fields" action="" method="post" id="post_settings_form_fields" class="form-horizontal">
            ...
            <div class='meta-box'>
                <div <?php $my_close_open_win_id = 'bk_settings_form_fields'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');"><br></div>
                    <h3 class='hndle'><span><?php _e('Form fields labels', 'wpdev-booking'); ?></span></h3><div class="inside">
                        ...
                        $show_untill_version_update = '5.4';  $wpbc_settings_element = 'dismiss_new_selectbox_field_free'; if ( ( version_compare(WP_BK_VERSION_NUM, $show_untill_version_update ) < 0 ) && ( '1' != get_user_option( 'booking_win_' . $wpbc_settings_element ) ) ) { ?><div id="<?php echo $wpbc_settings_element; ?>"  class="new-label clearfix-height new-label-settings" style="margin-left: -31px;"><a class="tooltip_bottom" data-original-title="<?php _e('Hide','wpdev-booking'); ?>" rel="tooltip" href="javascript:void(0)"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $wpbc_settings_element; ?>');jQuery('#<?php echo $wpbc_settings_element; ?>').hide();" ><img src="<?php echo WPDEV_BK_PLUGIN_URL; ?>/img/label_new_blue.png" style="width:24px; height:24px;"></a></div><?php } /**/ ?> 
                        <div class="control-group">
                          <label for="booking_form_field_label6" class="control-label" style="font-weight:bold;"><?php _e('Selectbox Label', 'wpdev-booking'); ?> :</label>
                          <div class="controls"> 
                            ...
                            <div style="float:left;margin-top:-23px;">  
                                <label for="booking_form_field_values6" class="control-label" style="font-weight:bold;"><?php 
                                    _e('Selectbox Values', 'wpdev-booking');  ?> :
                                </label>
                            ...
                            <div class="clear"></div>
                            <p class="help-block"><?php _e('Activate or deactivate field and change the label title', 'wpdev-booking'); ?></p>
                            <p class="help-block"><?php _e('Enter dropdown options. One option per line.', 'wpdev-booking'); ?></p>
                          </div>
                        </div>
                        ...
                        ?>
                        <div class="control-group">
                          <label for="name" class="control-label" style="font-weight:bold;"><?php _e('Field Label', 'wpdev-booking'); ?> #3:</label>
                          <div class="controls"> 
          ...
          <input class="button-primary button" style="" type="submit" value="<?php _e('Save Changes', 'wpdev-booking'); ?>" name="Submit" />
          <div class="clear" style="height:10px;"></div>                  
        </form>
    </div>
 <?php
        ...
        <form  name="post_settings_email_templates" action="" method="post" id="post_settings_email_templates" >
            ...
            <div id="visibility_container_email_new_to_admin" class="visibility_container" style="display:block;">
                ...
                <div class='meta-box'> <div <?php $my_close_open_win_id = 'bk_settings_emails_to_admin'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');" ><br></div>
                      <h3 class='hndle'><span><?php _e('Email to "Admin" after a new booking', 'wpdev-booking'); ?></span></h3> <div class="inside">

                    <table class="form-table email-table0" >
                        <tbody>
                            <tr>
                                <th scope="row"><?php _e('Status', 'wpdev-booking'); ?>:</th>
                                <td>
                                    <fieldset>
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="email_reservation_adress" ><?php _e('To', 'wpdev-booking'); ?>:</label></th>
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="email_reservation_from_adress" ><?php _e('From', 'wpdev-booking'); ?>:</label></th>
                                <td><input id="email_reservation_from_adress" name="email_reservation_from_adress" class="regular-text code" type="text" size="45" value="<?php echo $email_reservation_from_adress; ?>" />
                                    <span class="description"><?php printf(__('Type the default %sadmin email%s sending the booking confimation. You can use this %s shortcode.', 'wpdev-booking'),'<b>','</b>', '<code>[visitoremail]</code>');?></span>
                                </td>
                            </tr>

                            <tr valign="top">
                                    <th scope="row"><label for="email_reservation_subject" ><?php _e('Subject', 'wpdev-booking'); ?>:</label></th>
                                    <td><input id="email_reservation_subject" name="email_reservation_subject"  class="regular-text code" type="text" size="45" value="<?php echo $email_reservation_subject; ?>" />
                                        <span class="description"><?php printf(__('Type your email %ssubject%s for the booking confimation message.', 'wpdev-booking'),'<b>','</b>');?></span>
                                    </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row"><label for="email_reservation_content" ><?php _e('Content', 'wpdev-booking'); ?>:</label></th>
                                <td>     <?php /**/
                                      ...
                                      <p class="description"><?php printf(__('Type your %semail message content for checking booking%s in. ', 'wpdev-booking'),'<b>','</b>');  ?></p>
                                </td>
                            </tr>
                            <tr><td></td>
                                <td>
                                      <?php 
                                        ...
                                        email_help_section($skip_shortcodes, sprintf(__('For example: "You have a new reservation %s on the following date(s): %s Contact information: %s You can approve or cancel this booking at: %s Thank you, Reservation service."', 'wpdev-booking'),'','[dates]&lt;br/&gt;&lt;br/&gt;','&lt;br/&gt; [content]&lt;br/&gt;&lt;br/&gt;', htmlentities( ' <a href="[moderatelink]">'.__('here','wpdev-booking').'</a> ') . '&lt;br/&gt;&lt;br/&gt; ') );
                                      ?>                                                      
                                </td>
                            </tr>
                        </tbody>
            ...
            <div id="visibility_container_email_new_to_visitor" class="visibility_container" style="display:none;">
                ...
                <div class='meta-box'> <div <?php $my_close_open_win_id = 'bk_settings_emails_to_person_after_new'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');" ><br></div>
                      <h3 class='hndle'><span><?php _e('Email to "Person" after they make a new reservation', 'wpdev-booking'); ?></span></h3> <div class="inside">
                    ...
                    <table class="form-table email-table0" >
                        <tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="email_newbookingbyperson_adress" ><?php _e('From', 'wpdev-booking'); ?>:</label></th>
                                <td><input id="email_newbookingbyperson_adress"  name="email_newbookingbyperson_adress" class="regular-text code" type="text" size="45" value="<?php echo $email_newbookingbyperson_adress; ?>" />
                                    <span class="description"><?php printf(__('Type the default %sadmin email%s sending the booking confimation', 'wpdev-booking'),'<b>','</b>');?></span>
                                </td>
                            </tr>

                            <tr valign="top">
                                    <th scope="row"><label for="email_newbookingbyperson_subject" ><?php _e('Subject', 'wpdev-booking'); ?>:</label></th>
                                    <td><input id="email_newbookingbyperson_subject"  name="email_newbookingbyperson_subject" class="regular-text code" type="text" size="45" value="<?php echo $email_newbookingbyperson_subject; ?>" />
                                        <span class="description"><?php printf(__('Type email subject for %svisitor after creating a new reservation%s.', 'wpdev-booking'),'<b>','</b>');?></span>
                                    </td>
                            </tr>

                            <tr valign="top">
                                <th scope="row">
                                    <label for="email_newbookingbyperson_content" ><?php _e('Content', 'wpdev-booking'); ?>:</label></th>
                                <td>     <?php /**/
                                      ...
                                      <p class="description"><?php printf(__('Type your %semail message for visitor after creating a new reservation%s', 'wpdev-booking'),'<b>','</b>');?></p>
                                </td>
                            </tr>
                            <tr><td></td>
                                <td>                                                      <?php
                                        ...
                                        email_help_section($skip_shortcodes, sprintf(__('For example: "Your reservation %s on these date(s): %s is processing now! We will send confirmation by email. %s Thank you, Reservation service."', 'wpdev-booking'),'', '[dates]','&lt;br/&gt;&lt;br/&gt;[content]&lt;br/&gt;&lt;br/&gt;' ) );
                                      ?>
                            </td></tr>
                        </tbody>
                    </table>
            ...
            <div id="visibility_container_email_approved" class="visibility_container" style="display:none;">
                ...
                <div class='meta-box'> <div <?php $my_close_open_win_id = 'bk_settings_emails_to_person_after_approval'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');" ><br></div>
                      <h3 class='hndle'><span><?php _e('Email to "Person" after booking is approved', 'wpdev-booking'); ?></span></h3> <div class="inside">
                    ...
                    <table class="form-table email-table0" >
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><?php _e('Send to Admin', 'wpdev-booking'); ?>:</th>
                                <td>
                                    <fieldset>
                                        <label for="is_email_approval_send_copy_to_admin">
                                            <input id="is_email_approval_send_copy_to_admin" name="is_email_approval_send_copy_to_admin" 
                                                   ...
                                                   />
                                            <?php _e('Check this box to send copy of this email to Admin', 'wpdev-booking'); ?>
                                        </label>
                                    </fieldset>   
                                </td>
                            </tr>                                            
                            <tr valign="top">
                                <th scope="row"><label for="email_approval_adress" ><?php _e('From', 'wpdev-booking'); ?>:</label></th>
                            ...
                            <tr valign="top">
                                    <th scope="row"><label for="email_approval_subject" ><?php _e('Subject', 'wpdev-booking'); ?>:</label></th>
                                    <td><input id="email_approval_subject"  name="email_approval_subject" class="regular-text code" type="text" size="45" value="<?php echo $email_approval_subject; ?>" />
                                        <span class="description"><?php printf(__('Type your email subject for the %sapproved booking%s.', 'wpdev-booking'),'<b>','</b>');?></span>
                                    </td>
                            </tr>

                            <tr valign="top">
                                    <th scope="row"><label for="email_approval_content" ><?php _e('Content', 'wpdev-booking'); ?>:</label></th>
                                    <td>     <?php /**/
                                      ...
                                      <p class="description"><?php printf(__('Type your %semail message for the approved booking%s from the website', 'wpdev-booking'),'<b>','</b>');?></p>
                                    </td>
                            </tr>
                            <tr valign="top"><td></td>
                                <td>
                                      <?php
                                        ...
                                        email_help_section($skip_shortcodes, sprintf(__('For example: "Your reservation %s on these date(s): %s has been approved.%s Thank you, Reservation service."', 'wpdev-booking'),'', '[dates]','&lt;br/&gt;&lt;br/&gt;[content]&lt;br/&gt;&lt;br/&gt;') );
                                      ?>
                                </td>
                            </tr>
                        </tbody>
            ...
            <div id="visibility_container_email_declined" class="visibility_container" style="display:none;">
                ...
                <div class='meta-box'> <div <?php $my_close_open_win_id = 'bk_settings_emails_to_person_after_deny'; ?>  id="<?php echo $my_close_open_win_id; ?>" class="postbox <?php if ( '1' == get_user_option( 'booking_win_' . $my_close_open_win_id ) ) echo 'closed'; ?>" > <div title="<?php _e('Click to toggle','wpdev-booking'); ?>" class="handlediv"  onclick="javascript:verify_window_opening(<?php echo get_bk_current_user_id(); ?>, '<?php echo $my_close_open_win_id; ?>');" ><br></div>
                      <h3 class='hndle'><span><?php _e('Email to "Person" after their booking has been denied', 'wpdev-booking'); ?></span></h3> <div class="inside">
                    ...
                    <table class="form-table email-table0" >
                        <tbody>
                            ...
                            <tr valign="top">
                                <th scope="row"><label for="email_deny_adress" ><?php _e('From', 'wpdev-booking'); ?>:</label></th>
                            ...
                            <tr valign="top">
                                    <th scope="row"><label for="email_deny_subject" ><?php _e('Subject', 'wpdev-booking'); ?>:</label></th>
                                    <td><input id="email_deny_subject"  name="email_deny_subject" class="regular-text code" type="text" size="45" value="<?php echo $email_deny_subject; ?>" />
                                        <span class="description"><?php printf(__('Type your email subject for the %sdenied booking%s.', 'wpdev-booking'),'<b>','</b>');?></span>
                                    </td>
                            </tr>

                            <tr valign="top">
                                    <th scope="row"><label for="email_deny_content" ><?php _e('Content', 'wpdev-booking'); ?>:</label></th>
                                    <td>     <?php /**/
                                        ...
                                        <p class="description"><?php printf(__('Type your %semail message for the denied booking%s from the website', 'wpdev-booking'),'<b>','</b>');?></p>
                                    </td>
                            </tr>
                            ...
                            <tr valign="top"><td></td>
                                <td>
                                      <?php
                                        ...
                                        email_help_section($skip_shortcodes, sprintf(__('For example: "Your reservation %s on these date(s): %s has been canceled. Please contact us for more information. %s Thank you, Reservation service."', 'wpdev-booking'), '' ,'[dates]' , '&lt;br/&gt;&lt;br/&gt;[denyreason]&lt;br/&gt;&lt;br/&gt;[content]&lt;br/&gt;&lt;br/&gt;') );
                                      ?>
...
function email_help_section( $skip_shortcodes = array() , $email_example = '') {
        ?>
            <div class="wpbc-help-message" style="margin-top:10px;">
                ...
                <p class="description" style="font-weight:normal;"><?php printf(__('You can use (in subject and content of email template) any shortcodes, which you used in the booking form. Use the shortcodes in the same way as you used them in the content form at Settings Fields page.', 'wpdev-booking'));?></p>
                <br/>
                <p class="description"><strong><?php printf(__('You can use following shortcodes in content of this template', 'wpdev-booking'));?></strong>: </p>
                <?php } else { ?>
                <p class="description"><strong><?php printf(__('You can use following shortcodes in content of this template', 'wpdev-booking'));?></strong>: </p>
                <?php }  ?>
                <p class="description" style="font-weight:normal;"><?php 
                    if ( ! class_exists('wpdev_bk_personal') ) 
                        printf(__('%s - inserting data info about the booking', 'wpdev-booking'),'<code>[content]</code>');
                    else
                        printf(__('%s - inserting data info about the booking, which you configured in the content form at Settings Fields page', 'wpdev-booking'),'<code>[content]</code>');
                ?>, </p>
                <p class="description"><?php printf(__('%s - inserting ID of booking ', 'wpdev-booking'),'<code>[id]</code>');?>, </p>
                <?php if ( ! in_array('bookingtype', $skip_shortcodes)) { ?>
                <p class="description"><?php printf(__('%s or %s - inserting the title of the booking resource ', 'wpdev-booking'),'<code>[resource_title]</code>','<code>[bookingtype]</code>');?>, </p>
                <?php } if ( ! in_array('cost', $skip_shortcodes)) { ?>
                <p class="description"><?php printf(__('%s - inserting the cost of  booking ', 'wpdev-booking'),'<code>[cost]</code>');?>, </p>
                <?php } ?>
                                                                 

                <p class="description"><?php printf(__('%s - inserting the dates of booking', 'wpdev-booking'),'<code>[dates]</code>');?>, </p>
                <?php if ( ! in_array('check_in_date', $skip_shortcodes)) { ?>
                <p class="description"><?php printf(__('%s - inserting check-in date (first day of reservation),', 'wpdev-booking'),'<code>[check_in_date]</code>');?>, </p>
                <?php } if ( ! in_array('check_out_date', $skip_shortcodes)) { ?>
                <p class="description"><?php printf(__('%s - inserting check-out date (last day of reservation),', 'wpdev-booking'),'<code>[check_out_date]</code>');?>, </p>
                <?php } if ( ! in_array('dates_count', $skip_shortcodes)) { ?>
                <p class="description"><?php printf(__('%s - inserting the number of booking dates ', 'wpdev-booking'),'<code>[dates_count]</code>');?>, </p>
                <?php } ?>
                <?php if ( class_exists('wpdev_bk_personal') ) { ?>
                <hr />
                <p class="description"><?php printf(__('%s - inserting your site URL ', 'wpdev-booking'),'<code>[siteurl]</code>');?>, </p>                    
                <p class="description"><?php printf(__('%s - inserting IP address of the user who made this action ', 'wpdev-booking'),'<code>[remote_ip]</code>');?>, </p>                                    
                <p class="description"><?php printf(__('%s - inserting contents of the User-Agent: header from the current request, if there is one ', 'wpdev-booking'),'<code>[user_agent]</code>');?>, </p>                    
                <p class="description"><?php printf(__('%s - inserting address of the page (if any), where visitor make this action ', 'wpdev-booking'),'<code>[request_url]</code>');?>, </p>                    
                <p class="description"><?php printf(__('%s - inserting date of this action ', 'wpdev-booking'),'<code>[current_date]</code>');?>, </p>                    
                <p class="description"><?php printf(__('%s - inserting time of this action ', 'wpdev-booking'),'<code>[current_time]</code>');?>, </p>                    
                <hr />
                <?php } else { ?>
                <p class="description"><?php printf(__('%s - inserting your site URL ', 'wpdev-booking'),'<code>[siteurl]</code>');?>, </p>                    
                <?php } ?>
                ...
                <p class="description"><?php printf(__('%s - inserting moderate link of new booking ', 'wpdev-booking'),'<code>[moderatelink]</code>');?>, </p>
                <?php } ?>
                <?php if ( class_exists('wpdev_bk_personal') ) { ?>
                    <?php if ( ! in_array('visitorbookingediturl', $skip_shortcodes)) { ?>
                    <p class="description"><?php printf(__('%s - inserting link to the page where visitor can edit the reservation,  (possible to use the %s parameter for setting different %s of this page. Example: %s )', 'wpdev-booking'),'<code>[visitorbookingediturl]</code>', '"url"', 'URL', '<em>[visitorbookingediturl url="http://www.server.com/custom-page/"]</em>');?>, </p>
                    <?php } if ( ! in_array('visitorbookingcancelurl', $skip_shortcodes)) { ?>
                    <p class="description"><?php printf(__('%s - inserting link to the page where visitor can cancel the reservation, (possible to use the %s parameter for setting different %s of this page. Example: %s )', 'wpdev-booking'),'<code>[visitorbookingcancelurl]</code>', '"url"', 'URL', '<em>[visitorbookingcancelurl url="http://www.server.com/custom-page/"]</em>');?>, </p>
                    <?php } if ( ! in_array('visitorbookingpayurl', $skip_shortcodes)) { ?>
                    <p class="description"><?php printf(__('%s - inserting link to payment page where visitor can pay for the reservation  (possible to use the %s parameter for setting different %s of this page. Example: %s )', 'wpdev-booking'),'<code>[visitorbookingpayurl]</code>', '"url"', 'URL', '<em>[visitorbookingpayurl url="http://www.server.com/custom-page/"]</em>');?>, </p>
                    <?php } ?>

                    <?php if ( ! in_array('paymentreason', $skip_shortcodes)) { ?>
                    <p class="description"><?php printf(__('%s - add the reason for booking payment, you can enter it before sending email, ', 'wpdev-booking'),'<code>[paymentreason]</code>');?>, </p>
                    <?php } ?> 
                <?php } ?>
                <?php if ( ! in_array('denyreason', $skip_shortcodes)) { ?>
                <p class="description"><?php printf(__('%s - add the reason booking was cancelled, you can enter it before sending email, ', 'wpdev-booking'),'<code>[denyreason]</code>');?>, </p>
                <?php } ?>
                <br/>
                <p class="description"><strong><?php _e('HTML tags is accepted.', 'wpdev-booking');?></strong></p>
                <?php make_bk_action('show_additional_translation_shortcode_help'); ?>
        ...
        <div class="booking-submenu-tab-container">
            <div class="nav-tabs booking-submenu-tab-insidecontainer">
                ...
                <a href="javascript:void(0)" onclick="javascript:jQuery('.visibility_container').css('display','none');jQuery('#visibility_container_email_approved').css('display','block');jQuery('.nav-tab').removeClass('booking-submenu-tab-selected');jQuery(this).addClass('booking-submenu-tab-selected');"
                   ...
                   original-title="<?php _e('Customization of email template, which is sending to Visitor after approval of booking', 'wpdev-booking');?>" >
