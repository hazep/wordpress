...
class WPBC_Welcome {
    ...
    private $asset_path = 'http://wpbookingcalendar.com/assets/'; //'http://dev/assets/'; //
    ...
    public function content_whats_new() {
        ...
        ?><div class="wrap about-wrap wpbc-welcome-page">
            ...
            $this->show_col_section( array( 
                                          array( 'h4'   => 'Selectbox in booking form',
                                                 'text' => 'Ability to use **drop down list** in your booking form. You can configure **selections** of the different options, like **number of visitors, times, etc**... *Please note, the times will be saved to the DB and is not using for availability. If you need bookings for the specific times, you need to check <a href="http://wpbookingcalendar.com/demo/">Business Small</a> or higher versions.*' ) 
                                        , array(  'img'  => '5.3/selectbox.png', 'img_style'=>'margin-top:20px;' ) 
                                        ) 
                                    );  
            ...
            $this->show_col_section( array( 
                                          array(  'img'  => '5.3/email-templates.png', 'img_style' => 'width: 85%;margin:10px 12%;float:right;box-shadow: 0 1px 3px #777777;' ) 
                                        , array(  'h4'   => 'Improved Emails Configuration'
                                                , 'text' => 'Visual editors for the email templates at the Booking > Settings > Emails page. You can edit your email templates by using Visual editor or Text *(HTML)* form.' ) 
                                        ) 
                                    );
            ...
            $this->show_col_section( array( 
                              array( 'h4'   => 'Double booking checking on server side',
                                     'text' => 'You can activate **checking to prevent double booking**, during **submitting booking**. This feature useful to prevent double booking of the same date(s) or time(s), if several visitors try to book the same date(s) in same calendar during the same time (same session).' ) 
                            , array(  'img'  => '5.3/server-checking.png', 'img_style'=>'margin-top:20px;width: 99%;' ) 
                            ) 
                        );  
            ...
            $this->show_col_section( array( //'h3'   => 'Under the Hood', 
                                          array(  'h4'   => 'Updated translation', 
                                                  'text' => '<ul>
                                                                <li style="margin-left: 1em;">**Slovak** *by Martin Galdun* [**67%** completed]</li>
                                                                <li style="margin-left: 1em;">**German** *by Andreas Dupp* [**27%** completed]</li>
                                                                <li style="margin-left: 1em;">**Polish** *by Danek Szczepan* [**100%** completed]</li>
                                                                <li style="margin-left: 1em;">**Spanish** *by Juan C* [**100%** completed]</li>
                                                            </ul>' 
                                               ), 
                                        array(  'h4'   => 'Nicer warnings   ', 
                                                'text' =>  'Showing warning message under calendar, instead of popup alerts, if user did not select day(s) in calendar during submiting booking.' 
                                              ),
                                        array(  'h4'  => 'Improvement in booking settings', 
                                                 'text' => 'Reordering some sections at the General Booking Settings page for having more logical view.'
                                               )  
                                        ) 
                                    );
        ...
        <?php
            ...
            $this->show_col_section( array( 
                              array( 'h4'   => 'Rates in days cells',
                                     'text' => 'Ability to show **daily cost** (rates) inside of the **days cells** in calendar(s). <br>*(Business Medium/Large, MultiUser)*' ) 
                            , array(  'img'  => '5.3/indays-rates2.png', 'img_style'=>'margin-top:20px;width: 99%;' ) 
                            ) 
                        );  
            ...
            $this->show_col_section( array( 
                               array(  'img'  => '5.3/form-fields.png', 'img_style'=>'margin-top:20px;width: 99%;margin-left:1%;' ) 
                             , array( 'h4'   => 'Edit toolbar for booking forms',
                                     'text' => 'New HMTL **edit toolbar** for the **Booking Forms** and **Content of Booking Fields** form at  Booking > Settings > Fields page. <br>*(Personal, Business Small/Medium/Large, MultiUser)*' ) 
            ...
            $this->show_col_section( array( 'h3'   => 'Under the Hood', 
                                        array(  //'h4'   => '', 
                                                  'text' => '**New**. Automatic **checking of new updates** in paid versions of Booking Calendar and show notifications on WordPress > Plugins page. <br>*(Personal, Business Small/Medium/Large, MultiUser)*' 
                                               ), 
                                        array(  //'h4'   => '', 
                                                'text' =>  '**Improvement**. Showing *"Form Fields"* and *"Content of Booking Fields"* at the same page. To prevent forget of editing both forms. <br>*(Personal, Business Small/Medium/Large, MultiUser)*' 
                                              ),
                                        array(  //'h4'  => '', 
                                                 'text' => '**Improvement**. Sort items from search availability results by *"booking resources priority"* descending order. <br/>*(Business Medium/Large, MultiUser)*'
                                               )  
                                        ) 
                                    );
            $this->show_col_section( array( 
                                        array(  //'h4'   => '', 
                                                  'text' => '**Improvement**. You can click on *booking resources labels* at Booking Listing page to show bookings only from specific resource. <br/>*(Personal, Business Small/Medium/Large, MultiUser)*' 
                                               ), 
                                        array(  //'h4'   => '', 
                                                'text' =>  '**Improvement**. You can click on *season filters labels* at Rates and Availability pages for fast editing of specific season. <br/>*(Business Medium/Large, MultiUser)*' 
                                              ),
                                        array(  //'h4'  => '', 
                                                 'text' => '**Improvement**. Do not show *times tooltip* over specific date cell, if booking made for several days with change-over days. <br/>*(Business Small/Medium/Large, MultiUser)*'
                                               )  
                                        ) 
                                    );
        ...
        ?>
            <div class="wrap about-wrap wpbc-welcome-page">
                ...
                <div class="feature-section col two-col"> 
                    <div class="col-1 last-feature"  style="margin-top: -110px;width:59%">                    
        ...
        <div class="wrap about-wrap wpbc-welcome-page">
                ...
                <table class="about-text" style="margin-bottom:30px;height:auto;font-size:1em;width:100%;" >
                    <tr>
                        ...
                        <td style="width:50%">                            
                            <a class="button button-primary" style="font-weight: bold;float: right; height: 36px; line-height: 34px;"  href="<?php echo wpbc_up_link(); ?>" target="_blank">&nbsp;<?php if ( wpbc_get_ver_sufix() == '' ) { _e('Purchase', 'wpdev-booking'); } else { _e('Upgrade Now', 'wpdev-booking'); } ?>&nbsp;&nbsp;</a>
                        </td>
                    </tr>
                </table>                        
            <?php
            
            echo '<div style="color: #999;font-size: 24px;margin-top: -25px;text-align: center;width: 100%;">';
                echo 'Get even more functionality with higher versions...';
            echo '</div>';
...
. '<p>' . 'You can even activate to show deposit payment form, only when  the difference between *"today"* and *"check in"* days more than specific number of days.' . '</p>'
. '<p>' . '* **Configuration.** Firstly you need to activate the *"Deposit payment"* option at the General Booking Settings page and then you can activate and configure deposit value for specific booking resources at the Booking > Resources > **Cost and rates** page by clicking on "**Deposit amount**" button.*' . '</p>'
                                              )
...
<?php
                            ...
                            ?>
                            <a class="button button-primary" style="font-weight: bold; height: 36px; line-height: 32px;font-size:15px;margin-top: -3px;"  href="<?php echo wpbc_up_link(); ?>" target="_blank">&nbsp;<?php if ( wpbc_get_ver_sufix() == '' ) { _e('Purchase', 'wpdev-booking'); } else { _e('Upgrade Now', 'wpdev-booking'); } ?>&nbsp;&nbsp;</a>
                    </td>
                </tr>
            </table> 
...
<p class="about-description"><?php _e( 'We&#8217;ve assembled some links to get you started:',
        'wpdev-booking' ); ?></p>
...
<li><div class="welcome-icon"><?php
    printf( __( 'Insert booking form %sshortcode%s into your %sPost%s or %sPage%s',
                    'wpdev-booking' ), '<strong>',
            '</strong>',
...
<li><div class="welcome-icon"><?php printf( __( 'or add booking calendar %sWidget%s to your sidebar.',
                'wpdev-booking' ),
...
<li><div class="welcome-icon"><?php
printf( __( 'Check %show todo%s that and what %sshortcodes%s are available.',
'wpdev-booking' ),
...
'</a>' );
?></div></li>
<li><div class="welcome-icon"><?php printf( __( 'Add new booking from your post/page or from %sAdmin Panel%s.',
'wpdev-booking' ),
...
<ul>
<li><div class="welcome-icon"><?php
printf( __( 'Check %sBooking Listing%s page for new bookings.',
'wpdev-booking' ),
...
?></div></li>                                                    
<li><div class="welcome-icon"><?php
printf( __( 'Configure booking %sSettings%s.', 'wpdev-booking' ),
'<a href="' . esc_url( admin_url( add_query_arg( array( 'page' => WPDEV_BK_PLUGIN_DIRNAME . '/' . WPDEV_BK_PLUGIN_FILENAME . 'wpdev-booking-option' ),
            'admin.php' ) ) ) . '">', '</a>' );
?></div></li>                            
<li><div class="welcome-icon"><?php
printf( __( 'Configure predefined set of your %sForm Fields%s.',
'wpdev-booking' ),
'<a href="' . esc_url( admin_url( add_query_arg( array( 'page' => WPDEV_BK_PLUGIN_DIRNAME . '/' . WPDEV_BK_PLUGIN_FILENAME . 'wpdev-booking-option',
'tab' => 'form' ), 'admin.php' ) ) ) . '">', '</a>' );
?></div></li>
<li><div class="welcome-icon"><?php
printf( __( 'Configure your predefined %sEmail Templates%s.',
'wpdev-booking' ),
'<a href="' . esc_url( admin_url( add_query_arg( array( 'page' => WPDEV_BK_PLUGIN_DIRNAME . '/' . WPDEV_BK_PLUGIN_FILENAME . 'wpdev-booking-option',
...
<h4><?php _e( 'Have a questions?',
'wpdev-booking' ); ?></h4>
<ul>
<li><div class="welcome-icon"><?php
printf( __( 'Check out our %sHelp%s', 'wpdev-booking' ),
'<a href="http://wpbookingcalendar.com/help/" target="_blank">',
'</a>' );
?></div></li>
<li><div class="welcome-icon"><?php
printf( __( 'See %sFAQ%s.', 'wpdev-booking' ),
'<a href="http://wpbookingcalendar.com/faq/" target="_blank">',
'</a>' );
?></div></li>
<li><div class="welcome-icon"><?php
printf( __( 'Still having questions? Contact %sSupport%s.',
'wpdev-booking' ),
...
printf( __( 'Need even more functionality? Check %s higher versions %s',
'wpdev-booking' ),
