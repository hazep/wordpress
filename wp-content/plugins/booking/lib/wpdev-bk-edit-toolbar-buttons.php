                    ...
                    <div id="popup_new_reservation" style="display:block;" class="booking_configuration_dialog">
                      ...
                      <div id="popup_new_reservation_main_content"><?php
                        ...
                        if( get_bk_version() !== 'free' ) {
                            ...
                            ?><div class="field">
                                  <fieldset>
                                      ...
                                      <span class="description"><?php _e('Select booking resource', 'wpdev-booking'); ?></span>
                                  </fieldset>
                              </div>                              
                        <?php } ?>
                        ...
                        <div class="field">
                            <fieldset>
                                ...
                                <span class="description"><?php _e('Select number of month to show for calendar.', 'wpdev-booking'); ?></span>
                            </fieldset>
                        </div>

                        <div class="field">
                            <fieldset>
                                <label for="start_month_active"><?php _e('Start month:', 'wpdev-booking'); ?></label>
                                ...
                                <span class="description"><?php _e('Select start month of calendar', 'wpdev-booking'); ?></span>
                            </fieldset>
                        </div>
                        ...
                        <div class="field">
                            <fieldset>
                                ...
                                <label for="calendar_or_form"><?php _e('Show in the page:', 'wpdev-booking'); ?></label>
                                </div>
                                <div style="float:left;">
                                ...
                                <?php if (class_exists('wpdev_bk_biz_l')) {  
                                  ?><span style="margin-left:5px;display:none;" id="dates_for_form"> <?php _e('for','wpdev-booking'); ?>
                                ...
                                <div class="clear"></div>
                                <p class="description"><?php _e('Select to show the entire booking form or the availability calendar only.', 'wpdev-booking'); ?></p>
                            </fieldset>
                        </div>                              
                      ...
                      <div style="height:1px;clear:both;width:100%;"></div>
                        ...
                        if ( class_exists('wpdev_bk_biz_m')) 
                            printf(__('%s or minimum and fixed number of days selection for the specific day of week or season.%s', 'wpdev-booking'),'<em>','</em>'); 
                        ?></div>
