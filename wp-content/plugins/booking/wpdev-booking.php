 ...
 * 
 * ====================================
 * Add showing message of selecting check  out date
 * Its inside of function selectDayPro(all_dates,   bk_type){
 * Add insettings ability  to activate and enter message
*/
